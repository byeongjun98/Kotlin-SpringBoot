package com.example.kopring_boot_template.Service

import com.example.kopring_boot_template.Entity.PostEntity
import com.example.kopring_boot_template.Repository.PostRepository
...
class PostService(private val repository: PostRepository) {
    ...
    fun updatePost(id:Long, name: String, age: Int): PostEntity? {
        ...
        exist?.let {
            repository.save(PostEntity(name = name, age = age))
        }
        return null
    }
